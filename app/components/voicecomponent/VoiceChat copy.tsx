...
import { FileUpload } from '@/app/components/voicecomponent/FileUpload';  // Importing FileUpload
...
export function VoiceChat() {
    ...
    const handleFileUploaded = async (file: File) => {
        ...
        try {
            ...
            setMicPermissionError(error instanceof Error ? error.message : 'خطا در پردازش فایل');
        } finally {
            setIsProcessing(false);
        }
    };
